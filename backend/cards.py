        ...
        cards.append(
            {
                ...
                "mirna_name": mirna,
                "gene_symbol": gene,
                "mirassist_score": row.get("mirassist_score"),
                "mirassist_model_score": row.get("mirassist_model_score"),
                "mirassist_model_version": row.get("mirassist_model_version"),
                "mirassist_score_rank_within_mirna": row.get("mirassist_score_rank_within_mirna"),
                "mirassist_filtered_rank": row.get("mirassist_filtered_rank"),
                "mirassist_score_percentile_within_mirna": row.get("mirassist_score_percentile_within_mirna"),
